# Generated by Django 2.2.1 on 2020-03-18 09:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, verbose_name='文章推荐位序')),
            ],
            options={
                'verbose_name': '推荐位序',
                'verbose_name_plural': '推荐位序',
            },
        ),
        migrations.CreateModel(
            name='Tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('excerpt', models.TextField(blank=True, max_length=100, verbose_name='摘要')),
                ...
                ('rank', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='myblog.Rank', verbose_name='推荐位序')),
                ('tags', models.ManyToManyField(blank=True, to='myblog.Tag', verbose_name='标签')),
